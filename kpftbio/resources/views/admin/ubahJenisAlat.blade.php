    ...
    <form action="{{ route('ubahGambarJenisAlat') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="image-container image-preview">
            <img id="imagePreview" class="card-img-top img-fluid"
                src='{{ asset("images/jenis_alat/$dataJenisAlat->gambar") }}' />
        </div>
            ...
            <tbody>
                @foreach ($dataAlat as $alat)
                    ...
                    <tr>
                        ...
                        <td><a href="{{ url('hapusAlat/' . $alat->id) }}" class="btn btn-danger"
                                onclick="return confirm('Hapus alat ({{ $dataJenisAlat->nama }} - {{ $alat->nomor }}) dan seluruh datanya?')">Hapus</a>
                        </td>
                        <td><button type="button" class="btn btn-info" idAlat="{{ $alat->id }}"
                                namaAlat="{{ $dataJenisAlat->nama }} - {{ $alat->nomor }}"
                                onClick='cetak_alat(this)'>Cetak</button></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
